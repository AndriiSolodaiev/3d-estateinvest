...
export default function s3dFlatFloor(i18n, flat, isChecked, flybyLists, labelsToShowInInfoBlock) {
  return `
    <div class="s3d-villa__floor" id="toScroll">
        ...
        <div class="s3d-villa__floor-inner">
            ${s3dFlatFloorDetails(i18n, flat, isChecked, flybyLists, labelsToShowInInfoBlock)}
