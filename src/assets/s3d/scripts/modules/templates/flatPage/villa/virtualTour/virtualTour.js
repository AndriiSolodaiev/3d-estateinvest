    ...
    return `
        <div class="s3d-villa__virtual-tour-wrap">
            ...
            <div class="s3d-villa__virtual-tour-iframe-wrap">
                ...
                ${isTouch ? `<div class="s3d-villa__virtual-tour-iframe-wrap-overlay">
                </div>` : ''}
                ${isTouch ? `<div class="s3d-villa__virtual-tour-iframe-wrap-menu">
                    ${ButtonWithoutIcon('s3d-villa__virtual-tour-iframe-wrap-close', 'data-mobile-room-tour="open"', i18n.t('Flat.virtual_tour_open'))}
                    ${ButtonWithoutIcon('s3d-villa__virtual-tour-iframe-wrap-close', 'data-mobile-room-tour="close" style="display: none"', i18n.t('Flat.virtual_tour_close'))}
                </div>`: ''}
