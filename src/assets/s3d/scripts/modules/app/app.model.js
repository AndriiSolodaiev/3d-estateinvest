...
class AppModel extends EventEmitter {
  ...
  async init() {
    ...
    this.preloader.show();
    const bottomLabels = this.config.plannings.card_bottom_labels || [];
    ...
    const filterModel = new FilterModel(
      {
        ...
        history: this.history,
        show_prices: this.config.show_prices,
        card_bottom_labels: this.config.plannings.card_bottom_labels,
        i18n: this.i18n,
  ...
  updateFsm(data, nextHistory = true, sliderData, cb) {
    ...
    config.card_bottom_labels = this.config.plannings.card_bottom_labels;
    config.parent = this;
