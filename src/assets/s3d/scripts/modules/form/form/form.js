    ...
    resources: {
      ...
      ro: {
        translation: {
          ...
          sending: 'Se trimite',
          title: 'ȚI-AI GĂSIT VIITOAREA TA LOCUINȚĂ?',
          subtitle:
            'Completează formularul pentru a primi detalii despre apartament şi procesul de achiziţie.',
          ...
          send_fail:
            'Mesajul nu a fost trimis din cauza unei erori necunoscute a serverului. Cod: [send_fail] ',
          invalid_form:
            'Mesajul nu a fost trimis din cauza unei erori necunoscute a serverului. Cod: [invalid_form] ',
          front_error:
            'Mesajul nu a fost trimis din cauza unei erori necunoscute a serverului. Cod: [front_error] ',
          invalid_upload_file: 'Eroare la încărcarea fișierului. Cod: [invalid_upload_file] ',
          invalid_recaptcha:
            'Te rugăm să completezi captcha și să încerci din nou. Cod: [invalid_recaptcha] ',
      ...
      ru: {
        translation: {
          ...
          subtitle:
            'Заполните форму, чтобы получить больше информации о недвижимости и деталях покупки.',
          'Your name': 'Ваше имя:',
          'Your phone': 'Ваш телефон:',
          'Your email': 'Ваш email:',
